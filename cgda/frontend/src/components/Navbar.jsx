...
const Navbar = forwardRef(function Navbar({ title, user, onLogout, showUserControls = true }, ref) {
  return (
    <header ref={ref} className="sticky top-0 z-50 bg-slateink-50/80 backdrop-blur border-b border-slateink-100">
      <div className="mx-auto max-w-7xl px-4 lg:px-6 py-3 flex items-center justify-between gap-4">
        ...
        {showUserControls && (
          <div className="flex items-center gap-2">
            ...
            <Button onClick={onLogout} variant="dark" size="md">
