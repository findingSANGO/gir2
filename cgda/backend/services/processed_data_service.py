...
class ProcessedDataService:
    ...
    def _preprocess_file_into_db(
        ...
        *,
        ...
        try:
            close_raw_for_created = opt("close_date", "close date", "closed_date", "closed date")
        ...
        # IMPORTANT (MVP): do not merge/append multiple shapes for the same source.
        # Rebuild the processed dataset for this raw file deterministically.
        ...
        closed_raw = opt("close_date", "close date", "closed_date", "closed date")
            ...
            rows.append(
                {
                    ...
                    "source_row_index": int(i) if i is not None else None,
